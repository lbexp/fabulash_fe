        ...
        var table = $('#table_treatment_active').DataTable({
            ...
            columns: [{
                ...
                render: function(data, type, full, meta) {
                    ...
                    return `
                    <a href="user_superadmin/${status[full.status].href}" class="btn btn-sm btn-brand" style="color:white;border-radius:2rem"><i class="fa fa-info-circle"></i> Rincian</a>`;
                },
            }],
            columnDefs: [{
...
var initTablePaidTreatment = function() {
        ...
        var table = $('#table_treatment_paid').DataTable({
            ...
            columns: [{
                ...
                render: function(data, type, full, meta) {
                    return `
                    <a href="user_superadmin/treatment_detail_paid.html" class="btn btn-sm btn-brand" style="color:white;border-radius:2rem"><i class="fa fa-info-circle"></i> Rincian</a>`;
                },
            }],
            columnDefs: [{
...
var initTableTreatmentDetail = function() {
    ...
    var initTableKaryawan = function() {
        ...
        var datatable = table.DataTable({
            ...
            columns: [{
                ...
                render: function(data, type, full, meta) {
                    return `
                    <a href="user_superadmin/hr_karyawan_detail.html" class="btn btn-sm btn-brand" style="color:white;border-radius:2rem"><i class="fa fa-info-circle"></i> Rincian</a>`;
                },
            }, ],
            columnDefs: [{
                targets: [0, 1, 2, 3],
    ...
    var initTableVoucher = function() {
        var table = $('#table_voucher');
        // begin first table
        var datatable = table.DataTable({
            order: [],
            info: true,
            ...
            responsive: true,
            ajax: {
                url: 'source/superadmin/list-voucher.json',
                type: 'POST',
                data: {
                    pagination: {
                        perpage: 50,
            ...
            columns: [{
                ...
                render: function(data, type, full, meta) {
                    return `
                    <a href="user_superadmin/voucher_detail.html" class="btn btn-sm btn-brand" style="color:white;border-radius:2rem"><i class="fa fa-info-circle"></i> Rincian</a>`;
                },
            }, ],
            columnDefs: [{
                targets: [0, 1, 2, 3],
    ...
    var initTableDetailVoucher = function() {
        var table = $('#table_detail_voucher');
        // begin first table
        var datatable = table.DataTable({
            order: [],
            info: true,
            ...
            responsive: true,
            ajax: {
                url: 'source/superadmin/list-detail-voucher.json',
                type: 'POST',
                data: {
                    pagination: {
                        perpage: 50,
    ...
    var initTableFinancePayroll = function () {
        ...
        var datatable = table.DataTable({
            ...
            columns: [{
                ...
                render: function(data, type, full, meta) {
                    return `
                    <a href="user_superadmin/finance_payroll_detail.html" class="btn btn-sm btn-brand" style="color:white;border-radius:2rem"><i class="fa fa-info-circle"></i> Rincian</a>`;
                },
            }],
            columnDefs: [{
                targets: [0, 1, 2, 3],
    ...
    var initTableFinancePinjaman = function () {
        ...
        var datatable = table.DataTable({
            ...
            columns: [{
                ...
                render: function(data, type, full, meta) {
                    return `
                    <button type="button" class="btn btn-sm btn-success" style="border-radius:2rem" onClick="swalLunas();"><i class="fa fa-check-circle"></i> Lunas</button>`;
                },
            }],
            columnDefs: [{
                targets: [0, 1, 2, 3, 4, 5, 6],
    ...
    var initTablePengeluaran = function() {
        ...
        var table = $('#table_finance_pengeluaran').DataTable({
            ...
            columns: [{
                ...
                render: function(data, type, full, meta) {
                    return `
                    <a href="user_superadmin/finance_pengeluaran_detail.html" class="btn btn-sm btn-brand" style="color:white;border-radius:2rem"><i class="fa fa-info-circle"></i> Rincian</a>`;
                },
            }],
            columnDefs: [{
                targets: [0, 1, 2, 3, 4, 5, 6, 7, 8],
    ...
    var initTableCustomer = function() {
        ...
        var datatable = table.DataTable({
            ...
            columns: [{
                ...
                render: function(data, type, full, meta) {
                    return `
                    <a href="user_superadmin/customer_detail.html" class="btn btn-sm btn-brand" style="color:white;border-radius:2rem"><i class="fa fa-info-circle"></i> Rincian</a>`;
                },
            }, ],
            columnDefs: [{
                targets: [0, 1, 2, 3, 4, 5, 6],
    ...
    var initTableInventoryGudang = function () {
        ...
        var datatable = table.DataTable({
            ...
            columns: [{
                ...
                render: function(data, type, full, meta) {
                    return `
                    <a href="user_superadmin/inventory_gudang_detail.html" class="btn btn-sm btn-brand" style="color:white;border-radius:2rem"><i class="fa fa-info-circle"></i> Rincian</a>`;
                },
            }],
            columnDefs: [{
                targets: [0, 1, 2, 3, 4],
    ...
    var initTableInventoryStudio = function () {
        ...
        var datatable = table.DataTable({
            ...
            columns: [{
                ...
                render: function(data, type, full, meta) {
                    return `
                    <a href="user_superadmin/inventory_studio_view.html" class="btn btn-sm btn-brand" style="color:white;border-radius:2rem"><i class="fa fa-info-circle"></i> Rincian</a>`;
                },
            }],
            columnDefs: [{
                targets: [0, 1, 2, 3, 4],
    ...
    var initTableInventoryStudioView = function () {
        ...
        var datatable = table.DataTable({
            ...
            columns: [{
                ...
                render: function(data, type, full, meta) {
                    return `
                    <a href="user_superadmin/inventory_studio_detail.html" class="btn btn-sm btn-brand" style="color:white;border-radius:2rem"><i class="fa fa-info-circle"></i> Rincian</a>`;
                },
            }],
            columnDefs: [{
                targets: [0, 1, 2, 3, 4],
    ...
    var initTableInventoryTherapist = function () {
        ...
        var datatable = table.DataTable({
            ...
            columns: [{
                ...
                render: function(data, type, full, meta) {
                    return `
                    <a href="user_superadmin/inventory_therapist_view.html" class="btn btn-sm btn-brand" style="color:white;border-radius:2rem"><i class="fa fa-info-circle"></i> Rincian</a>`;
                },
            }],
            columnDefs: [{
                targets: [0, 1, 2, 3],
